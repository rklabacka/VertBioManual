...
\noindent\textbf{Lab Manual:}
Located on canvas under <insert path here>
...
* Due to the COVID-19 pandemic, labs (with the exception of field trips- see ~\ref{FieldNote}) will be conducted electronically over Canvas.
