...
* Due to the COVID-19 pandemic, labs (with the exception of field trips- see \hyperref[SecFieldNote]{Field Notebook Section}) will be conducted electronically over Canvas. You can complete all of the labs on your own time with the exception of: (1) the lab introduction, (2) your assigned field trip, (3) the proposal workshop, and (4) the proposal panel. The lab introduction, proposal workshop, and proposal panel will be conducted over zoom during your scheduled lab time. Details on these items will be provided later. Here is the zoom meeting information:
\begin{itemize}
